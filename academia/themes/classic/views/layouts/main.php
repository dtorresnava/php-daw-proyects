...
<div class="container" id="page">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Home', 'url'=>array('/site/index')),
                                ...
                                array('label'=>'Usuarios', 'url'=>array('/usuarios/index'), 'visible'=>Yii::app()->user->name=='admin'),
                                array('label'=>'Administración', 'url'=>array('/usuarios/admin'), 'visible'=>Yii::app()->user->name=='admin'),
	...
	<div id="footer">
                <a href="index.php?theme=bootstrap" >Cambiar a vista Responsive</a>
